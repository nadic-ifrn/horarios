        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('admin.table', $table) }}" class="btn btn-sm btn-secondary">
                        <i class="nc-icon nc-minimal-left"></i> Voltar
                    </a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.update', [$table, $record->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    @endforeach <div class="form-group">
                        ...
                        <a href="{{ route('admin.table', $table) }}" class="btn btn-secondary">
